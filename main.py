...
if st.button("📄 Generate PDF Resume"):
    ...
    # Custom red heading style
    red_heading = ParagraphStyle(
        'RedHeading',
        parent=styles['Heading2'],
        textColor=colors.red
    )

    # Big red title for YR Digital
    ...
    # Add YR Digital Title
    story.append(Paragraph("🚀 YR Digital Resume Builder", red_title))
    ...
    if summary:
        story.append(Paragraph("Summary", red_heading))
        story.append(Paragraph(summary, styles['Normal']))
        story.append(Spacer(1, 12))

    if skills:
        story.append(Paragraph("Skills", red_heading))
        story.append(Paragraph(skills, styles['Normal']))
        story.append(Spacer(1, 12))

    if experience:
        story.append(Paragraph("Experience", red_heading))
